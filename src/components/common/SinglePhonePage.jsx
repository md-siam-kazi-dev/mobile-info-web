  ...
  return (
    ...
    <div data-theme="night" className="min-h-screen px-5 bg-base-100 font-[Syne,sans-serif]">
      ...
      <div className="container-div py-10 space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            <div className="xl:col-span-1">
              <SectionCard icon="🤖" title="Software">
                ...
                <SpecRow label="Slug"     value={<span className="font-mono text-xs text-base-content/50">{p.slug}</span>} />
              </SectionCard>
            </div>
        ...
        {/* ── FOOTER STRIP ─────────────────────────────────────────────── */}
        <div className="divider" />
        <div className="flex flex-wrap items-center justify-between gap-3 text-[11px] font-mono text-base-content/25 tracking-widest">
          <span>{p.slug}</span>
          <span>ID #{p.id}</span>
          <span>{p.reviews.toLocaleString()} reviews · {p.release_year}</span>
        </div>
